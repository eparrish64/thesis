...
\begin{figure}[!b]
    \centering
    \subfloat[Low Mass Selection]{\includegraphics[width=\textwidth]{appendices/cutflows/OneTag_EfficiencyOverlay_LowMass.pdf}}\\
    \subfloat[High Mass Selection]{\includegraphics[width=\textwidth]{appendices/cutflows/OneTag_EfficiencyOverlay_HighMass.pdf}}
...
\begin{figure}[!b]
    \centering
    \subfloat[Low Mass Selection]{\includegraphics[width=\textwidth]{appendices/cutflows/ZeroTag_EfficiencyOverlay_LowMass.pdf}}\\
    \subfloat[High Mass Selection]{\includegraphics[width=\textwidth]{appendices/cutflows/ZeroTag_EfficiencyOverlay_HighMass.pdf}}
...
\input{appendices/cutflows/cutflow-hh-yybb-low-1tag.tex}
\input{appendices/cutflows/cutflow-hh-yybb-high-1tag.tex}
\input{appendices/cutflows/cutflow-hh-yybb-low-0tag.tex}
\input{appendices/cutflows/cutflow-hh-yybb-high-0tag.tex}
