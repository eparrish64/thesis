...
\begin{itemize}
    \item Electrons: Being a charged lepton, in addition to the \gls{EM} showering, electrons interact with the \gls{ID}, leaving a track that can be extrapolated to the \gls{EM} cluster.
