\chapter{Theory}
    ...
    \section{The Standard Model}
        ...
        \begin{table}[!thp]
            ...
            \end{tabular}
            \caption{Fermions in the \gls{SM}, with their masses and charges listed \cite{pdg}.}
            \label{tab:fermions}
        \end{table}
...
%he resonant model probed is a \gls{THDM}, in which the higgs sector is extended through the addition of a second ``heavy Higgs.'' The result of this is five scalar states. The known CP-even Higgs, $h$, a heavier CP-even twin $H$, two charged Higgs bosons $H^\pm$, and a CP-odd pseudoscalar $A$.
