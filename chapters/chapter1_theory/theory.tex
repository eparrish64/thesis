...
%
In this formulation, $H(x)$ represents the Higgs field, and $v$ is known as the \glsfirst{vev}. A feature of this theory is the prediction of the W and Z boson masses:
%
\begin{equation}
