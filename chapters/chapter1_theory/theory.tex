...
%%%%%% Di-Higgs %%%%%%%%     
\subsection{The Higgs Boson at the \gls{LHC}}
...
The dominant Higgs boson production modes are shown in Figure \ref{fig:higgs-production-modes} as a function of the center-of-mass energy.

\glsfirst{ggF} production is the dominant Higgs boson production channel at the \gls{LHC}. At the current center-of-mass energy of 13 TeV, it makes up 87\% of Higgs boson events. In this production mode, two initial state gluons produce the Higgs boson through a heavy quark loop.
...
The remaining major Higgs boson production modes are vector boson associated production ($WH$ and $ZH$), top associated production (\tth and $tH$), and \bb fusion ($b\bar{b}H$).
