...
\section{Charged Higgs Bosons}\label{sec:Hpm}
	...
	\subsection{Previous Result}\label{ssec:Prev Hpm}
		...
		\begin{figure}[!h]
			\centering
			\subfloat[\label{fig:hpm-prev-limits_a}]{\includegraphics[width=0.5\linewidth]{chapters/chapter1_theory/images/Previous_Limits_Taujets.png}}
			\subfloat[\label{fig:hpm-prev-limits_b}]{\includegraphics[width=0.5\linewidth]{chapters/chapter1_theory/images/Previous_Limits_Taulep.png}} \\
			\subfloat[\label{fig:hpm-prev-limits_c}]{\includegraphics[width=0.75\linewidth]{chapters/chapter1_theory/images/Previous_Limits_Combined.png}}
