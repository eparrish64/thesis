\chapter{Event Reconstruction}\label{chap:reco}
	...
	\section{Topological Clusters}
		...
		The analysis discussed in this dissertation uses the Loose \gls{WP} for muons to allow for larger statistics in the signal region.
