\chapter{Search for Charged Higgs Bosons}\label{chap:hpana}
	...
	\section{Multivariate Analysis Techniques}\label{sec:mva}
		...
		\subsection{Input Variables Selection}\label{ssec:input-variables}
			...
			\end{equation}
			where $\pt^{\tau-\mathrm{track}}$ is the transverse momentum of the track associated with the 1-prong \tauhad candidate. As such, $\Upsilon$ is only defined for 1-prong \tauhad candidates.
