		...
		\subsection{Hyperparameter Optimization}\label{ssec:hpo}
			...
			\begin{table}[!htb]
			  \begin{center}
			    ...
			    width & \multicolumn{3}{c|}{32} \\ \hline
			    depth & \multicolumn{3}{c|}{10} \\ \hline
			    batch size & \multicolumn{3}{c|}{1025} \\ \hline
			    \end{tabular}}
			  \end{center}
			\end{table}
			...
			\begin{table}[!htb]
			  \begin{center}
			    ...
			    activation function & \multicolumn{3}{c|}{softsign} \\ \hline
			    loss function & \multicolumn{3}{c|}{binary cross-entropy} \\ \hline 
			    batch size & \multicolumn{3}{c|}{1024} \\ \hline
			    \end{tabular}}
			  \end{center}
			\end{table}
			...
			\begin{table}[!htb]
			  ...
			  \begin{center}
			    ...
			    dropout & \multicolumn{3}{c|}{0.1} \\ \hline
			    batch size & \multicolumn{3}{c|}{1024} \\ \hline
			    loss function & \multicolumn{3}{c|}{binary cross-entropy} \\ \hline
			    \end{tabular}}
			...
			\begin{table}[!htb]
			  ...
			  batch size & \multicolumn{4}{c|}{1024} \\ \hline
			  dropout & \multicolumn{4}{c|}{0.1} \\ \hline
			  activation function & \multicolumn{4}{c|}{LeakyReLU}  \\ \hline
			  loss function & \multicolumn{4}{c|}{binary cross-entropy} \\ \hline
			  \end{tabular}}
			...
			\begin{table}[!htb]
			  ...
			  activation function & \multicolumn{4}{c|}{LeakyReLU} \\ \hline
			  batch size & \multicolumn{4}{c|}{1024} \\ \hline
			  $\alpha$ & \multicolumn{4}{c|}{0.05} \\ \hline
			  loss function & \multicolumn{4}{c|}{binary cross-entropy} \\ \hline
			  \end{tabular}}
