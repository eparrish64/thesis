\chapter{Search for Charged Higgs Bosons}\label{chap:hpana}
	...
	\section{Signature and Event Selection}\label{sec:signal}
		...
		\subsection{Object Definitions}\label{ssec:object-def}
			...
			\begin{figure}
			\centering
			\includegraphics[width=.5\textwidth,keepaspectratio=true]{chapters/chapter6_HPlus/images/Electron_ID_Efficiency.png}
  ...
  %         \hline
	...
	\section{Expected Results}\label{sec:results}
		...
		\begin{table}
			...
			\hline
			\ttbar & $\phantom{}18443.27\phantom{.0}\pm\phantom{0}48.35\phantom{.0}\phantom{0}\begin{tabular}{c}+1545.67 \\-1697.11\end{tabular}$    \\ \hline
			Single-top-quark  & $\phantom{0}2284.34\phantom{.0}\pm\phantom{0}17.39\phantom{.0}\phantom{0}\begin{tabular}{c}+184.69 \\-207.49\end{tabular}$ \\ \hline
			$W \to \tau\nu$  & $\phantom{0}1979.17\phantom{.0}\pm\phantom{0}23.63\phantom{.0}\phantom{0}\begin{tabular}{c}+179.85 \\-229.80\end{tabular}$  \\ \hline
			$Z \to \tau\tau$  & $\phantom{00}242.12\phantom{.0}\pm\phantom{00}5.50\phantom{.0}\phantom{0}\begin{tabular}{c}+24.27 \\-32.88\end{tabular}$   \\ \hline
			Diboson ($WW, WZ, ZZ$) & $\phantom{00}133.76\phantom{.0}\pm\phantom{00}4.69\phantom{.0}\phantom{0}\begin{tabular}{c}+9.47 \\-12.61\end{tabular}$  \\ \hline
			Misidentified $e,\,\mu \to \tauhad$   & $\phantom{00}328.89\phantom{.0}\pm\phantom{00}6.85\phantom{.0}\phantom{0}\begin{tabular}{c}+25.60 \\-34.58\end{tabular}$  \\ \hline
			Misidentified $\mbox{jet} \to \tauhad$ & $\phantom{0}2506.28\phantom{.0}\pm\phantom{0}17.39\phantom{.0}\phantom{0}\begin{tabular}{c}+130.53 \\-133.40\end{tabular}$ \\ \hline
			\hline
		...
		\begin{table}
			...
			\hline
			$t\bar{t}$ & $43813.50\phantom{.0}\pm\phantom{0}76.85\phantom{.0}\phantom{0}\begin{tabular}{c}+1749.82 \\-1833.87\end{tabular}$ & $44486.48\phantom{.0}\pm\phantom{0}75.33\phantom{.0}\phantom{0}\begin{tabular}{c}+1811.78 \\-1907.08\end{tabular}$  \\ \hline
			Single-top-quark  & $\phantom{0}3260.52\phantom{.0}\pm\phantom{0}20.81\phantom{.0}\phantom{0}\begin{tabular}{c}+124.27 \\-134.66\end{tabular}$ & $\phantom{0}3873.35\phantom{.0}\pm\phantom{0}22.06\phantom{.0}\phantom{0}\begin{tabular}{c}+158.03 \\-165.92\end{tabular}$  \\ \hline
			...
			$Z \to \tau\tau$  & $\phantom{00}913.55\phantom{.0}\pm\phantom{0}20.42\phantom{.0}\phantom{0}\begin{tabular}{c}+64.56 \\-149.42\end{tabular}$  & $\phantom{00}845.89\phantom{.0}\pm\phantom{0}22.07\phantom{.0}\phantom{0}\begin{tabular}{c}+88.71 \\-111.03\end{tabular}$ \\ \hline
			...
			Misidentified $e,\,\mu \to \tauhad$   &   $\phantom{0}1083.97\phantom{.0}\pm\phantom{0}24.33\phantom{.0}\phantom{0}\begin{tabular}{c}+41.65 \\-73.42\end{tabular}$ & $\phantom{0}1060.30\phantom{.0}\pm\phantom{0}15.84\phantom{.0}\phantom{0}\begin{tabular}{c}+43.44 \\-70.69\end{tabular}$ \\ \hline
			Misidentified $\mbox{jet} \to \tauhad$ &   $\phantom{0}8662.43\phantom{.0}\pm\phantom{0}37.49\phantom{.0}\phantom{0}\begin{tabular}{c}+450.65 \\-470.53\end{tabular}$ & $\phantom{0}8426.64\phantom{.0}\pm\phantom{0}37.12\phantom{.0}\phantom{0}\begin{tabular}{c}+440.04 \\-459.88\end{tabular}$ \\ \hline
			\hline
