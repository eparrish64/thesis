...
\section{Theory }
  ...
  \begin{frame}[t]{The Higgs Boson}
    ...
    \column{.5\textwidth}
      ...
      \centering
      \begin{figure}
        \includegraphics[height=.5\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter2_theory/images/Higgs_Discovery_gam_gam.png}
  ...
  \subsection{Charged Higgs Bosons }
    ...
    \column{.5\textwidth} 
      \begin{figure}
      \includegraphics[width=.75\textwidth,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter2_theory/images/HPlus_to_tb_Limits.png}
      \caption{\tiny \cite{Hpm-to-tb} }
      \end{figure}
    \column{.5\textwidth} 
      \begin{figure}
      \includegraphics[width=.75\textwidth,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter2_theory/images/HPlus_to_cb_Limits.png}
...
\section{\HpmLong }
  ...
  \begin{frame}[t]{Background Estimation}
    ...
    % \end{table}
      ...
      \column{.5\textwidth}
      \centering
      \includegraphics[height=.4\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taujets/met_et_SR_TAUJET.png}
      \includegraphics[height=.4\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taulep/met_et_SR_TAULEP.png}
    \end{columns}
  \end{frame}
  ...
  \begin{frame}[t]{Background Estimation: $j \rightarrow \tau$ Fakes}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item In SR, measure fraction of fakes $(\alpha)$ using template fit of $\tau$ ID RNN score distributions using template shapes from $anti-\tau$ distributions in CRs 
  ...
  \subsection{Results }
    ...
    \begin{frame}[t]{PNN Results}
      \begin{columns}[t]
        \column{.3\textwidth}
        \includegraphics[height=.43\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taujets/clf_score_GB200_mass_80to80_SR_TAUJET.png}
        \includegraphics[height=.43\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taulep/clf_score_GB200_mass_80to80_SR_TAULEP.png}

        \column{.3\textwidth}
        \includegraphics[height=.43\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taujets/clf_score_GB200_mass_170to170_SR_TAUJET.png}
        \includegraphics[height=.43\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taulep/clf_score_GB200_mass_170to170_SR_TAULEP.png}

        \column{.3\textwidth}
        \includegraphics[height=.43\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taujets/clf_score_GB200_mass_1000to1000_SR_TAUJET.png}
        \includegraphics[height=.43\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taulep/clf_score_GB200_mass_1000to1000_SR_TAULEP.png}
      \end{columns}
    \end{frame}
