      ...
      \column{.5\textwidth}
        \begin{figure}
          \begin{columns}
            \column{.95\textwidth}
            \centering
            \includegraphics[height=.35\textheight,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter3_experiment/images/TileModuleCrossSection.png}
            \column{.05\textwidth}  
            \vspace{1cm}
...
\section{\HpmLong }
  ...
  \subsection{ MVA }
    ...
    \end{itemize}
    \centering
    \includegraphics[width=.75\textwidth,keepaspectratio=true]{/Users/eparrish/Work/thesis/chapters/chapter6_HPlus/images/taulep_limits_PNN_low_lv_vs_high_lv.eps}
