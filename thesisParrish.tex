...
\title{Search for Charged Higgs Bosons in the \HpmLong Final State with \LUMI of \pp Collision Data at \sqs with the ATLAS Experiment}
...
\director{Dhiman Chakraborty Jahred Adelman}
\directorone{Dhiman Chakraborty}
\directortwo{Jahred Adelman}
...
\include{chapters/chapter1_introduction/introduction}
\include{chapters/chapter2_theory/theory}
\include{chapters/chapter3_experiment/experiment}
\include{chapters/chapter4_simulation/simulation}
\include{chapters/chapter5_eventreconnstruction/eventreconstruction}
\include{chapters/chapter6_HPlus/HPlus}
...
\input{appendices/app_tile}
\input{appendices/app_fake_factors}
\input{appendices/app_validation_plots}
\input{appendices/app_pnn_scores}
